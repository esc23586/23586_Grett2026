...
SETUP:
	...
	LDI r16, 0b00000011; recordar qeu es lógica inversa.
	OUT PORTC, r16


	; ----- PUERTO D -----
	; PD1 como salida (LED de carry) En este caso  D1 será donde esté el led, por ahora.
...
; Lectura de las entradas, en el registro de r17
    ...
    ANDI R17, 0b00000001    ; leer PC0 
    BREQ BOTON1_PRESIONADO   ; si es 0 ? presionado inc

	IN  R17, PINC; Leo Nuevamente el estado actual de los pines C
	ANDI R17,  0b00000010 ; Aqui leo PC1
	BREQ BOTON2_PRESIONADO   ; si es 0 ? presionado dec
...
BOTON1_PRESIONADO:
    ...
    ANDI Contador1, 0b00001111   ; limitar a 4 bits
    OUT PORTB, Contador1
