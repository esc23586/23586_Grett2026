...
//COnfiguración del clck prescaler
	...
	//cONFIGURAR timero e interrupciones-------------------------------------------------------------
	LDI R16, (0x00
	OUT TCCR0A, R16
	LDI R16, (1<<CS01)|(1 CS00);
	OUT TCCROB, R16
	LDI R16m 156 ;ESTABA EN 160
	OUT OCR0A, R16
	// HABILITAR OVERFLOW
	LDI  R16, (1<<TOTE0)
	STS TIMSKO, R16
...
MAIN_LOOP:
	CPI R20, 100
	BRNE MAIN_LOOP
	SBI PINB, PINB5//TOGGLE
	SBI PINB, PINB0 

	CLR R20
	; COSAS IMPORTANTES INTERRUPICONES
